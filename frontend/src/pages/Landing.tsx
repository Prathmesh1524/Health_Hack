          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div>
              <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Healthcare Hackathon</span>
                <span className="block text-blue-600">Innovate for a Healthier Future</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Join us in revolutionizing healthcare through technology. Sign up now for our upcoming hackathon and be part of the solution!
              </p>
            ...
            <div className="mt-10">
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Improve Patient Care</h3>
                    <p className="mt-2 text-base text-gray-500">
                      Develop solutions that directly impact and improve patient care and outcomes.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Connect Doctors</h3>
                    <p className="mt-2 text-base text-gray-500">
                    Get a fully experienced Doctor's consultancy 
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Network</h3>
                    <p className="mt-2 text-base text-gray-500">
                      Connect with like-minded innovators, mentors, and healthcare professionals.
                    </p>
                  </div>
                </div>
              </div>
